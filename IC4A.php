...
$query = "SELECT M.MedicamenteNume ,M.MedicamenteTip , M.pret ,S.SubstanteActiveEfect  FROM Medicamente M 
JOIN substanteactive S ON M.SubstanteActive_idSubstanteactive=S.idSubstanteactive
 WHERE M.pret IN 
 ( SELECT max(pret) from medicamente Join Substanteactive S2 ON SubstanteActive_idSubstanteactive=S2.idSubstanteactive WHERE
 S2.SubstanteActiveEfect = '$Efect')
 AND S.SubstanteActiveEfect='$Efect'";
